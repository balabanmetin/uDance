...
if conda info --envs | grep "udance" > /dev/null; then
	...
	basecomm=$(echo conda create -y -c bioconda -c conda-forge --channel smirarab --name udance python=3.8  pip newick_utils=1.6 setuptools seqkit=2.1.0 scipy dendropy=4.5.2 pandas=1.3.0 snakemake raxml=8.2.12 iqtree=2.1.2 treeshrink=1.3.9 fasttree=2.1.10 julia=1.7.1 gappa=0.7.1 trimal=1.4.1) 
